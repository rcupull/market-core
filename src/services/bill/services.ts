import { BillModel } from './schemas';
import { Bill, BillDetailedAmount } from './types';

import { GetAllBillArgs, getAllFilterQuery } from './utils';
...
> {
  constructor(
    ...
    super(BillModel, getAllFilterQuery);
  }
