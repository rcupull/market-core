...
export const commissionsByBusinessTypeSchemaDefinition: SchemaDefinition<CommissionsByBusinessType> =
...
export const AdminConfigModel = getMongoModel<AdminConfig>(
  'AdminConfig',
  AdminConfigShema,
  'admin_config'
);
