...
export declare enum ShoppingState {
...
export interface ShoppingPostData extends Pick<Post, '_id' | 'images' | 'name' | 'routeName' | 'currency' | 'currenciesOfSale'> {
    commissions: Commissions;
    salePrice: number;
}
export declare enum ShoppingDeliveryState {
