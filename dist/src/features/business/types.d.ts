...
export type SearchLayoutType = 'none' | 'left' | 'center' | 'right' | 'postCategories' | 'postCategoriesScrollable' | 'postCategoriesExcluded' | 'postCategoriesExcludedScrollable';
...
export declare enum BusinessNotificationFlags {
    NEW_SHOPPING = "NEW_SHOPPING"
}
export declare enum DeliveryConfigType {
    NONE = "NONE",
    FREE = "FREE",
    REQUIRED = "REQUIRED",
    OPTIONAL = "OPTIONAL"
...
export declare enum PostFormField {
    /**
