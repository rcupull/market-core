...
exports.AuthSessionServices = void 0;
const schemas_1 = require("./schemas");
const types_1 = require("./types");
const ModelCrudTemplate_1 = require("../../utils/ModelCrudTemplate");
class AuthSessionServices extends ModelCrudTemplate_1.ModelCrudTemplate {
    constructor() {
...
exports.AuthSessionServices = AuthSessionServices;
